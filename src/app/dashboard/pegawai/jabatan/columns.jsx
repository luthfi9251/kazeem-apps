...
import { deleteJabatanPegawai } from "./_actions/jabatanpegawai";
...
export const columns = [
    ...
    {
        accessorKey: "pegawai_count",
        header: "Pegawai Terkait",
    },
    {
        id: "actions",
        cell: ({ row }) => {
                ...
                <>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem>
                                <Link
                                    href={`/dashboard/pegawai/jabatan/detail/${user.id}`}
                                    className="w-full"
                                >
                                    Detail
                                </Link>
                            ...
                            <DropdownMenuItem>
                                <Link
                                    href={`/dashboard/pegawai/jabatan/edit/${user.id}`}
                                    className="w-full"
                                >
                                    Edit
                                </Link>
