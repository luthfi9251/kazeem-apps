...
const columns = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return dayjs(row.original.jam_keluar)
                .locale("id")
                .format("HH:mm A");
        },
    },
    {
        accessorKey: "jam_kembali",
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="Jam Kembali" />
        ),
        cell: ({ row }) => {
            return dayjs(row.original.jam_kembali)
                .locale("id")
                .format("HH:mm A");
        },
    },
                            ...
                            <DropdownMenuItem className="cursor-pointer">
                                <p
                                    ...
                                    onClick={() => {
                                        ...
                                        generatePDFIzinKeluar(dataRow, dataSantri);
                                    }} 
                                >
                                    Export
                                </p>
